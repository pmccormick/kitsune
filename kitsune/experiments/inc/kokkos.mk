...
ifeq ($(BUILD_CUDA_EXPERIMENTS),true)
  ...
  KOKKOS_NVCC_FLAGS?= $(NVCC_CXX_FLAGS) -I$(KOKKOS_CUDA_PREFIX)/include/ -ccbin $(CUDA_PATH)/bin
  KOKKOS_CLANG=$(KITSUNE_PREFIX)/bin/clang
  KOKKOS_CLANG_CUDA_PREFIX?=$(KITSUNE_PREFIX)/opt/kokkos/clang-cuda
  KOKKOS_CLANG_CUDA_FLAGS?= $(CLANG_CUDA_FLAGS) -fPIC -std=c++17 -fno-exceptions -I$(KOKKOS_CLANG_CUDA_PREFIX)/include/
...
ifeq ($(BUILD_HIP_EXPERIMENTS),true)
  ...
  KOKKOS_HIP_FLAGS?=$(HIPCC_CXX_FLAGS) -std=c++17 -fno-exceptions -I$(KOKKOS_HIP_PREFIX)/include/ -ffp-contract=fast
endif
